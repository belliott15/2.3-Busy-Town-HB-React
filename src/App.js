  ...
  return (
    <div className="App">
      <div className="fight">
        <div className="monster">
          ...
          <div className='buttons'>
            ...
            <button onClick={() => { alienSize < 25 ? 
              setAlienSize(alienSize + monsterModifier) : setAlienSize(alienSize - monsterModifier);}}>
            ...
            <button onClick={() => { lizardSize > 1 ? 
              setLizardSize(lizardSize - monsterModifier) : setLizardSize(lizardSize + monsterModifier);}}>
        ...
        <div className="monster">
          ...
          <div className="buttons">
            ...
            <button onClick={() => { lizardSize < 30 ? 
              setLizardSize(lizardSize + monsterModifier) : setLizardSize(lizardSize - monsterModifier);}}>
                Yegads! The lizard is ramping up to its final form!
            </button>
            {/* when you click this button, the alien's size in state should go up by one */}
            <button onClick={() => { alienSize > 1 ? 
              setAlienSize(alienSize - monsterModifier) : setAlienSize(alienSize + monsterModifier);}}>
      ...
      <div className="buttons">
        ...
        <button onClick={() => {setLightColor('yellow'); traffic.splice(0, 1); setTraffic([...traffic]);}}>Yellow</button>
